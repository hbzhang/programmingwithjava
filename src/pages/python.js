...
const PythonPage = ({ data, location }) => {
            ...
            <Layout mainClass="bg-whitegrey-l2 pb-vw3" bodyClass="bg-white">
                <section className="bg-setup">
                    <div className={`${Spirit.page.xl} tc-ns pt-vw6 pt-vw5-ns pb-vw5 white`}>
                        <h1 className={`${Spirit.sectionHeading} gh-integration-header-shadow`}>Tutorial on Python</h1>
                        <p className={Spirit.sectionSubHeading}>
                           In this tutorial, you will become familar with <strong>Python</strong> so that you can use it for computer vision class.
                        </p>
                    </div>
                </section>
