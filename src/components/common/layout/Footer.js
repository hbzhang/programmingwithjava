...
const Footer = () => (
    <footer className="pt10 pt-vw3-ns pb-vw3 bt b--whitegrey">
        ...
        <section className={`${Spirit.page.xl} grid-12`}>
           ...
           <a href="http://144.75.191.138:2369/" className="db col-12 col-6-ns pr2 pr20-ns pt12 pt7-ns pb7 pl2 pl30-ns relative tdn bn br-ns b--whitegrey dark-h4-hover">
                <Icon name="cloud-upload" className="absolute top-0 top-10-ns left-2 left-10-ns w10 w13-ns h-auto fill-green" />
                <h2 className={`${Spirit.h4} darkgrey`}></h2>
                <h2 className={`${Spirit.small} midgrey mt1`}>
                   <strong className="blue"> Pursue your dream!</strong>
                </h2>
            </a>


           <a href="http://www.arxiv-sanity.com/" className="db col-12 col-6-ns pr2 pr20-ns pt18 pt7-ns pb7 pl2 pl30-ns bt b--whitegrey bn-ns relative tdn dark-h4-hover">
                <Icon name="blocks" className="absolute top-6 top-10-ns left-2 left-10-ns w10 w13-ns h-auto fill-purple" />

                <h4>Read Interesting Computer Vision Papers!</h4>
            </a>
...
<section className={`${Spirit.page.xl} m1 mt-vw3-ns`}>
            ...
            <div className="bt b--whitegrey flex justify-between items-center pt4">
                ...
                <ul className="flex list pa0 ma0 items-center">
                    <li className={listItemClass}><a href="https://scholar.google.com/citations?user=0D41b5AAAAAJ&hl=en" className="link pa2 midgrey hover-blue dib mr0">Hongbo Zhang</a></li>
                </ul>
            </div>
