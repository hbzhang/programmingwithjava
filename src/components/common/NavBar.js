...
const NavBar = ({ theme }) => {
    ...
    return (
        ...
        {/*<a href="https://ghost.org" className="nudge-top--3">
                ...
                <Link to="/" className={`${themeClasses[theme].docsTitleClass} gh-nav-logo-suffix relative ma0 ml4 pa0 pl4 f6 lh-1-5 fw4 link nudge-top--1`}>VMI CIS Computer Vision Tutorial Site</Link>
            </div>
            ...
            <div className="navbar-container">
                <div className="dn flex-ns flex-auto items-center overflow-x-auto mr12 mr0-l ml5 ml0-l pb20">
                    <Link to="/python/" className={`${themeClasses[theme].menuItem} nowrap f8 pa3 mr1 mr3-l`}>PYTHON</Link>
                    <Link to="/csharp/" className={`${themeClasses[theme].menuItem} nowrap f8 pa3 mr1 mr3-l`}>C#</Link>
                    <Link to="/imagefiltering/" className={`${themeClasses[theme].menuItem} nowrap f8 pa3 mr1 mr3-l`}>Image Filtering</Link>
